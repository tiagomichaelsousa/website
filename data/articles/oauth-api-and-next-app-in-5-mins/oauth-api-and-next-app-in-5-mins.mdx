---
title: 'OAuth API and Next App in 5 minutes'
date: '2022-05-23'
image: thumbnail.jpg
...
authors:
  - tsousa
description: |
  Nowadays authenticating apps with OAuth and Laravel almost looks like cheating! Imagine in 5 minutes having an API in Laravel, a frontend en Next and OAuth integration with 1001 services available!
